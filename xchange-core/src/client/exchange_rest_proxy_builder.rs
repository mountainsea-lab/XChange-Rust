...
// use crate::client::{
//     ClientConfigCustomizer, DefaultProxyFactory, Interceptor, RestApi, RestProxyFactory,
// };
// use crate::exchange_specification::ExchangeSpecification;
// use std::sync::Arc;
// use std::time::Duration;
//
// pub struct ExchangeRestProxyBuilder<T> {
//     api_marker: std::marker::PhantomData<T>,
...
// }
//
// impl<T> ExchangeRestProxyBuilder<T>
// where
//     T: RestApi + 'static,
// {
...
//             .ok_or(BuildError::MissingField("base_url missing".to_string()))?;
//
//         Ok(Self {
//             api_marker: std::marker::PhantomData,
//             exchange_spec: spec,
//             base_url, // String guaranteed
//             client_config: None,
//             customizers: vec![],
//             interceptors: vec![],
...
//         let mut cfg = match self.client_config.take() {
//             Some(c) => c,
//             None => Self::create_client_config(&self.exchange_spec),
//         };
//
//         // apply customizers
...
//     }
//
//     /// Translated from Java createClientConfig()
//     fn create_client_config(spec: &ExchangeSpecification) -> ClientConfig {
//         let mut cfg = ClientConfig::default();
//
//         if let Some(t) = spec.http_conn_timeout {
//             cfg.timeout = Duration::from_millis(t);
//         }
//
//         if let Some(t) = spec.http_read_timeout {
//             cfg.read_timeout = Duration::from_millis(t);
//         }
//
